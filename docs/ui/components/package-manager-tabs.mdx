---
description: Компонент PackageManagerTabs для отображения команд установки для разных менеджеров пакетов.
overviewHeaders: []
---

import { PackageManagerTabs, Tag } from '@rspress/core/theme';
