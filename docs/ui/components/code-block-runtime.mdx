...
Если вам нужно только ссылаться на внешние файлы как на блоки кода, используйте статический синтаксис [блока кода из файла](/guide/use-mdx/code-blocks#file-code-block). Он обрабатывается на этапе компиляции, обеспечивает лучшую производительность и меньший размер бандла.
