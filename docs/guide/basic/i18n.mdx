...
Создайте новый файл `i18n.json` в текущем рабочем пространстве, рядом с файлом `rspress.config.ts`:
...
С помощью файла `_meta.json` можно задать содержимое панели навигации и сайдбара. Подробности — в разделе [Автонавигация](/guide/basic/auto-nav-sidebar).
