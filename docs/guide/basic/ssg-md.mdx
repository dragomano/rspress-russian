...
SSG-MD требует React 19 или выше. Если вы используете React 18 или более раннюю версию, пожалуйста, используйте вместо этого [@rspress/plugin-llms](/plugin/official-plugins/llms).
