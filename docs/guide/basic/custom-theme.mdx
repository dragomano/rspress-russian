...
Если вы используете Coding Agent, вы можете установить навык агента [rspress-custom-theme](https://github.com/rstackjs/agent-skills#rspress-custom-theme), чтобы дать ему возможность сгенерировать для вас совершенно новую тему.

Дополнительную информацию о разработке с помощью ИИ в Rspress см. на странице [ИИ](/guide/start/ai).
