...
Если вы используете агента для написания кода, можно установить [навык агента `rspress-custom-theme`](https://github.com/rstackjs/agent-skills#rspress-custom-theme), чтобы дать ему возможность сгенерировать для вас совершенно новую тему.
