...
:::warning
Перед использованием этого плагина убедитесь, что в вашей среде развёртывания правильно настроена страница возврата. Подробнее см. в руководстве [SSG refresh-404](/guide/basic/ssg#refresh-404).
