...
Используйте `llmsTxt` для формирования полного содержимого `llms.txt` на основе метаданных сайта и разделов страниц. Подробности см. в разделе [Настройка llms.txt](/guide/basic/ssg-md#customize-llmstxt).
...
При включении этой опции Rspress нормализует неканонические URL-адреса в браузере во время запуска клиентского приложения, используя фактически сопоставленный маршрут как единственный источник истины. Итоговый формат URL определяется параметром [`route.cleanUrls`](#routecleanurls).
...
:::warning Клиентская нормализация
...
| Входящий URL         | Сопоставленный маршрут | Изменение URL в браузере            |
| -------------------- | ---------------------- | ----------------------------------- |
| `/file`              | `/file`                | Без изменений                       |
| `/file.html`         | `/file`                | `replaceState` → `/file`            |
| `/file/`             | `/file`                | `replaceState` → `/file`            |
| `/file/index`        | `/file`                | `replaceState` → `/file`            |
| `/file/index.html`   | `/file`                | `replaceState` → `/file`            |
| `/folder`            | `/folder/`             | `replaceState` → `/folder/`         |
| `/folder.html`       | `/folder/`             | `replaceState` → `/folder/`         |
| `/folder/`           | `/folder/`             | Без изменений                       |
| `/folder/index`      | `/folder/`             | `replaceState` → `/folder/`         |
| `/folder/index.html` | `/folder/`             | `replaceState` → `/folder/`         |
...
| Входящий URL         | Сопоставленный маршрут | Изменение URL в браузере                     |
| -------------------- | ---------------------- | -------------------------------------------- |
| `/file`              | `/file`                | `replaceState` → `/file.html`                |
| `/file.html`         | `/file`                | Без изменений                                |
| `/file/`             | `/file`                | `replaceState` → `/file.html`                |
| `/file/index`        | `/file`                | `replaceState` → `/file.html`                |
| `/file/index.html`   | `/file`                | `replaceState` → `/file.html`                |
| `/folder`            | `/folder/`             | `replaceState` → `/folder/index.html`        |
| `/folder.html`       | `/folder/`             | `replaceState` → `/folder/index.html`        |
| `/folder/`           | `/folder/`             | `replaceState` → `/folder/index.html`        |
| `/folder/index`      | `/folder/`             | `replaceState` → `/folder/index.html`        |
| `/folder/index.html` | `/folder/`             | Без изменений                                |
...
Форматы канонических URL соответствуют механизму [HTML handling](https://developers.cloudflare.com/workers/static-assets/routing/advanced/html-handling/) в Cloudflare. Однако Cloudflare выполняет HTTP-перенаправления на стороне сервера, тогда как эта опция лишь обновляет URL в адресной строке браузера.
...
- `auto`: Перенаправлять с любой локали на ближайшую настроенную локаль.
- `never`: Отключить автоматические перенаправления на локаль.
- `only-default-lang`: Перенаправлять только при открытии посетителем локали по умолчанию.

:::tip Предпочтительны перенаправления на стороне сервера
