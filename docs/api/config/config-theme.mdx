...
Это полезно при использовании функции [llms](/guide/basic/ssg-md) для генерации файлов llms.txt, поскольку пользователи могут копировать или открывать Markdown-контент в AI-инструментах.
