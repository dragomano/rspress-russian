...
const INTRODUCTION_MARKDOWN = `# Введение

Rspress — молниеносно быстрый генератор статических сайтов, созданный на основе Rsbuild.

\`\`\`ts title="index.ts"
console.log('Привет, Rspress');
\`\`\``;
        ...
        <div className={styles.tabPanels}>
          ...
          >
            <div className={styles.pagePreview}>
              <div className={styles.pageHead}>
                <div className={styles.pageTitle}>Введение</div>
                <button
                  type="button"
              ...
              <div className={styles.pageCode}>
                ...
                <div className={styles.pageCodeBody}>
                  <span>console.log('Привет, Rspress');</span>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div className={styles.llmsContent}>
              <div className={styles.llmsTitle}># Введение</div>
              <div className={styles.mdText}>
                Rspress — молниеносно быстрый генератор
              </div>
              <div className={styles.mdText}>статических сайтов, созданный на основе Rsbuild.</div>
              <div className={styles.mdFence}>{'```'}ts title="index.ts"</div>
              <div className={styles.mdText}>console.log('Привет, Rspress');</div>
          ...
          >
            <div className={styles.llmsContent}>
              ...
              <div className={styles.llmsQuote}>
                Молниеносно быстрый генератор статических сайтов
              </div>
              <div className={styles.llmsH2}>## Документация</div>
              <div className={styles.llmsItem}>
                - <span>[Введение](/guide/start/introduction.md)</span>
              </div>
              <div className={styles.llmsItem}>
                - <span>[Быстрый старт](/guide/start/getting-started.md)</span>
              </div>
            </div>
          </div>
        </div>
